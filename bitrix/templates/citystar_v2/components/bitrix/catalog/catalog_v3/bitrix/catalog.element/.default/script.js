(function (window) {
    ...
    window.JCCatalogElement.prototype.UpdateRow = function (intNumber, activeID, showID, canBuyID)
    {
        ...
        if (-1 < intNumber && intNumber < this.obTreeRows.length)
        {
            ...
            if (!!RowItems && 0 < RowItems.length)
            {
                ...
                if (pictMode)
                {
                    obData.style.paddingTop = strNewZero;
                }
                for (i = 0; i < RowItems.length; i++)
                {
    ...
    {            
        ...
        {
            obBasketProps = BX('tabs');//BX(this.visual.BASKET_PROP_DIV);
        }
        if (!!obBasketProps)
        {
            ...
            propCollection = obBasketProps.getElementsByTagName('span');
            if (!!propCollection && !!propCollection.length)
            {
                for (i = 0; i < propCollection.length; i++)
                {
                   // debugger;
                    ...
                    {
                        if(propCollection[i].getAttribute('class') == 'item_info_section-size active'){
                            this.basketParams['SIZE'] = propCollection[i].innerHTML;
                            foundValues = true;
                        }
                    }
                }
 ...
 $(function(){
 $('.item_info_section-size').click(function(e){
 e.preventDefault();
 $('.item_info_section-size').removeClass('active');
 var size = $(this).text();
